...
# TRAEMOS BASTANTES DATOS
URL = f"https://api.mercadopublico.cl/servicios/v1/publico/licitaciones.json?ticket={TICKET}&cantidad=100"
...
# FILTRAMOS CON PANDAS SI HAY BÚSQUEDA
if busqueda:
